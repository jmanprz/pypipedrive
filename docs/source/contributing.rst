...
Meanwhile, post your questions at the project's `Github Page <http://www.github.com/jmanprz/pypipedrive>`_. Remember: there are no stupid questions, only stupid silences.
...
You're welcome to `submit a pull request <https://github.com/jmanprz/pypipedrive/pulls>`_ for a bug fix or a new feature as long as you use the library.
...
4. You have your `commits signed <https://docs.github.com/en/authentication/managing-commit-signature-verification/about-commit-signature-verification>`_.
...
Built by `Juan Manuel M. Pérez <https://github.com/jmanprz>`_  from `® Magical Potion <https://magicalpotion.io?utm_source=pypipedrive&utm_medium=docs&utm_campaign=open_source>`_ for teams that need to enhance and customise their Pipedrive sales experience.